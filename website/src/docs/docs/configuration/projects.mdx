...
<Aside>
<Tip>
New folders are created under shuvmaki's projects directory. Run multiple isolated bots with separate projects directories using `--data-dir`; see [Advanced Setup](../guides/advanced-setup).
</Tip>
</Aside>
