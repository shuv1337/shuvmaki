---
title: Verbosity
description: Control how much tool activity shuvmaki shows in a thread, from full tool output down to text only.
icon: lucide:eye
---
...
At the default level, shuvmaki shows tool parts that matter for following the work:
