...
Run **`/diff`** in a thread or project channel. shuvmaki:
...
- **No changes** — if the working tree is clean, shuvmaki replies "No changes to show".
- **critique not installed** — shuvmaki tells you it's unavailable. It ships with shuvmaki in normal installs.
